                ...
                <div class="card-body">
                        ...
                        <form action="{{url('product-edit')}}/{{$data->id}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input value="{{old('price',$data->price)}}" type="text" class="form-control @error('price') is-invalid @enderror" id="price" name="price" placeholder="Type a price ...">
                                @error('price')
                                    <div class="invalid-feedback">
                                        {{$message}}
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control @error('photo') is-invalid @enderror" id="price" name="photo">
                                @error('photo')
                                    <div class="invalid-feedback">
                                        {{$message}}
                                    </div>
